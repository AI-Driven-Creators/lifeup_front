  ...
  <div class="card">
    ...
    <div class="space-y-4">
      ...
      <div class="flex justify-between items-center p-3 bg-green-50 rounded-lg">
        ...
        <span class="font-bold text-green-600 text-lg">{{ progress.completedTasks }}/{{ progress.totalTasks }}</span>
      </div>
      
      <!-- 獲得的經驗 -->
      <div class="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
        <span class="text-primary-700 font-medium">獲得的經驗</span>
        <span class="font-bold text-blue-600 text-lg">+{{ progress.experienceGained }} 經驗</span>
      </div>
      ...
      <div class="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
        ...
        <span class="font-bold text-purple-600 text-sm">
          智力 +{{ progress.attributeGains.intelligence }}，耐力 +{{ progress.attributeGains.endurance }}
        </span>
      </div>
    </div>
  </div>
